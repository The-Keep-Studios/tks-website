...
function unitydog_media_send_to_editor( $html, $id, $attachment ) 
{
	...
	return "[unity src=\"".$id."\" h=\"300\" fullscreen=\"no\"]";
}
...
function unitydog_unity( $atts ) 
{
	...
	return '<unitydog width="'.$width.'" height="'.$height.'" src="'.$url.'" extraClass="'.$classes.'" fullscreen="'.$fullscreen.'"
	preview="'.$preview.'"></unitydog>';
}
